...
cmd({
  ...
  try {
    ...
    // GitHub stats
    const githubRepo = 'https://whatsapp.com/channel/0029VaeIf8xAu3aUQm3QAV3A';

    // Check update status
    let updateMessage = `*✅ ʏᴏᴜʀ 𝐇𝐚𝐬𝐬𝐚𝐧-ᴍᴅ ʙᴏᴛ ɪs ᴜᴘ-ᴛᴏ-ᴅᴀᴛᴇ!*`;
    if (localVersion !== latestVersion) {
      updateMessage = `*😵‍💫 ʏᴏᴜʀ 𝐇𝐚𝐬𝐬𝐚𝐧-ᴍᴅ ʙᴏᴛ ɪs ᴏᴜᴛᴅᴀᴛᴇᴅ!*
...
*ᴜsᴇ .ᴜᴘᴅᴀᴛᴇ ᴛᴏ ᴜᴘᴅᴀᴛᴇ.*`;
    ...
    await conn.sendMessage(from, {
      image: { url: 'https://i.ibb.co/Y79jJfSh/getlos.jpg' },
      ...
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          ...
          newsletterName: '☇ 𝐌𝐫 𝐇𝐚𝐬𝐬𝐚𝐧 𝐒ʊ̊𝐏𝐏๏፝֟ɼʈ  ⃪🤖͎᪳᪳𝆺𝅥',
          serverMessageId: 143
        }
      }
    }, { quoted: mek });
