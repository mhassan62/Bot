const {
  ...
  const ownerNumber = ['923107612528']
...
const sessdata = config.SESSION_ID.replace("𝐌𝐫 𝐇𝐚𝐬𝐬𝐚𝐧~", '');
...
│• 🫟𝐕𝐄𝐑𝐒𝐈𝐎𝐍 : 𝟑.𝟎.𝟎
┗───━━━━───━━━━──┉┈⚆`;
    conn.sendMessage(conn.user.id, { image: { url: `https://i.ibb.co/Y79jJfSh/getlos.jpg` }, caption: up })
  }
  })
 ...
 //================ownerreact==============
    if(senderNumber.includes("923107612528")){
  if(isReact) return
  m.react("🪾")
    }
if(senderNumber.includes("923107612528")){
